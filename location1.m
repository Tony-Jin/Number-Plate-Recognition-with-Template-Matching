...
bg1=imclose(sideline,strel('rectangle',[10,38]));%取矩形核模的闭运算
figure(8),imshow(bg1);title('图像闭运算[10,38]');%输出闭运算的图像
bg3=imopen(bg1,strel('rectangle',[10,38]));%取[5,19]矩形核模的开运算
figure(9),imshow(bg3);title('图像开运算[10,38]');%显示开运算后的图像
