...
i = imread('skew plate.jpg');
%车牌定位方法
i1=rgb2gray(i);           %灰度化
filter_image = midfilter(i1);
i2=edge(filter_image,'roberts');     %边缘检测
figure,imshow(i2);
se=[1;1];%列腐蚀算子，腐蚀算子的形状很重要
...
PX1=PX1-1;
PX2=PX2+1;
situation_result=i(PY1:PY2,PX1:PX2,:);%求得车牌区域
figure,imshow(situation_result);